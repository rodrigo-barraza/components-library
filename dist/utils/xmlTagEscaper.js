...
export function escapeXmlDelimiterTags(content) {
    if (!content)
        return content;
    ...
    const processedSegments = segments.map((segment) => segment.replace(XML_TAG_PATTERN, (fullMatch, openOrClose, tagName, _attributes, _closing) => {
...
//# sourceMappingURL=xmlTagEscaper.js.map