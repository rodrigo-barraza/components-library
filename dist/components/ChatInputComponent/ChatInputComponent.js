...
export default function ChatInputComponent({ onSend, isTyping = false }) {
    ...
    return (_jsxs("div", { className: `chat-input-component ${styles['input-bar']}`, children: [_jsxs("div", { className: styles['input-container'], children: [_jsx("textarea", { ref: textareaRef, className: styles['textarea'], value: value, onChange: handleChange, onKeyDown: handleKeyDown, placeholder: "Type a message\u2026", rows: 1, disabled: isTyping, maxLength: maxLength, id: "chat-input", "aria-label": "Message input" }), _jsx("button", { className: `${styles['send-button']} ${canSend ? styles['send-active'] : ""}`, onClick: handleSubmit, disabled: !canSend, "aria-label": "Send message", id: "chat-send-button", children: _jsxs("svg", { viewBox: "0 0 24 24", width: "18", height: "18", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("line", { x1: "12", y1: "19", x2: "12", y2: "5" }), _jsx("polyline", { points: "5 12 12 5 19 12" })] }) })] }), isOverLimit && (_jsxs("span", { className: `${styles['char-count']} ${value.length >= maxLength ? styles['char-count-over'] : ""}`, children: [value.length, "/", maxLength] }))] }));
}
