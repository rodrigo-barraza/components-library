...
mobileBreakpoint = 768, // number — viewport width below which drawer mode activates
    ...
    const wrapperClasses = [
        ...
        .filter(Boolean)
        .join(" ");
    return (_jsxs(_Fragment, { children: [isMobile && showMobileHamburger && (_jsx("button", { type: "button", className: `${styles.mobileHamburgerButton} ${mobileOpen ? styles.mobileHamburgerButtonOpen : ""}`, onClick: mobileOpen ? handleMobileClose : handleMobileOpen, title: mobileOpen ? "Close navigation" : "Open navigation", "aria-label": mobileOpen ? "Close navigation menu" : "Open navigation menu", "aria-expanded": mobileOpen, children: mobileOpen ? _jsx(Icons.X, { size: 20, strokeWidth: 2 }) : _jsx(Icons.Menu, { size: 20, strokeWidth: 2 }) })), _jsxs("div", { className: wrapperClasses, children: [isMobile && mobileOpen && (_jsx("div", { className: styles.mobileScrim, onClick: handleMobileClose, "aria-hidden": "true" })), _jsxs("aside", { ref: sidebarReference, className: styles.sidebar, children: [(brandIcon || brandLabel) && (_jsxs("header", { className: styles.brand, children: [typeof brandIcon === "string" ? (
                                    // eslint-disable-next-line @next/next/no-img-element
                                    _jsx("img", { src: brandIcon, alt: brandLabel || "Brand", className: styles.brandIconImg })) : brandIcon ? (_jsx("div", { className: styles.brandIconNode, children: brandIcon })) : null, brandLabel && _jsx("span", { className: styles.brandLabel, children: brandLabel }), isMobile ? (_jsx("button", { type: "button", className: styles.mobileCloseButton, onClick: handleMobileClose, title: "Close menu", "aria-label": "Close navigation menu", children: _jsx(Icons.X, { size: 20 }) })) : collapsible ? (_jsx("button", { type: "button", className: styles.collapseButton, onClick: toggleCollapse, title: "Toggle Sidebar", "aria-label": "Collapse navigation sidebar", "aria-expanded": !collapsed, children: _jsx(Icons.ChevronsLeft, { size: 16 }) })) : null] })), _jsx("nav", { className: styles.navigationList, children: resolvedSections.map((section, sectionIndex) => (_jsxs(React.Fragment, { children: [section.label && (_jsx("div", { className: styles.navigationDivider, children: _jsx("span", { children: section.label }) })), section.items.map(renderNavItem)] }, section.label || sectionIndex))) }), _jsxs("footer", { className: styles.bottomActions, children: [bottomActions, hasThemePicker ? (_jsx(ThemePickerComponent, { theme: theme, themes: themes, onSelectTheme: setTheme, collapsed: isMobile ? false : collapsed })) : onToggleTheme ? (_jsx(TooltipComponent, { label: themeMeta.nextLabel + " Mode", position: "right", delay: 200, disabled: isMobile || !collapsed, className: styles.tooltipFill, children: _jsxs("button", { type: "button", className: styles.themeToggle, onClick: onToggleTheme, title: themeMeta.title, "aria-label": themeMeta.title, children: [_jsx(themeMeta.NextIcon, { size: 18, strokeWidth: 1.8, className: styles.navigationIcon }), _jsx("span", { className: styles.themeLabel, children: themeMeta.nextLabel })] }) })) : null] })] })] })] }));
}
