...
export default function BreadcrumbComponent({ items = [], separator = "chevron", className, ...rest }) {
    ...
    return (_jsx("nav", { "aria-label": "Breadcrumb", className: `breadcrumb-component ${styles['navigation-bar']} ${className || ""}`, ...rest, children: _jsx("ol", { className: styles['list'], children: items.map((item, i) => {
