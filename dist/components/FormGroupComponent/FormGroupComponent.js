...
export default function FormGroupComponent({ label, hint, readOnly = false, readOnlyContent, children, className, style, }) {
    return (_jsxs("div", { className: `${styles['form-group']}${className ? ` ${className}` : ""}`, style: style, children: [label && _jsx("label", { children: label }), readOnly ? _jsx("div", { className: styles['read-only-value'], children: readOnlyContent ?? "—" }) : children, hint && _jsx("span", { className: styles['hint'], children: hint })] }));
}
/**
