...
const LayoutHeaderComponent = forwardRef(function LayoutHeaderComponent({ title, titleIcon: TitleIconComponent, titleBadge, onBack, leadingToggle, trailingToggle, centerContent, metaContent, controls, isMobile = false, className, children, }, ref) {
