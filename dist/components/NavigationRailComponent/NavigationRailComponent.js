...
export default function NavigationRailComponent({ items = [], activeItem, onNavigate, fab, menuIcon, alignment = "top", labelsHidden = false, bottomSlot, LinkComponent, className = "", ariaLabel = "Main navigation", }) {
    ...
    return (_jsxs("nav", { className: `${styles.rail} ${className}`, "aria-label": ariaLabel, children: [menuIcon && (_jsx("div", { className: styles['menu-slot'], children: menuIcon })), fab && _jsx("div", { className: styles['fab-slot'], children: fab }), _jsx("div", { ref: destinationsRef, className: `${styles.destinations} ${styles[`align-${alignment}`]}`, role: "tablist", "aria-orientation": "vertical", onKeyDown: handleKeyDown, children: items.map((item, index) => {
                    ...
                    return (_jsx(TooltipComponent, { label: item.label, position: "right", delay: 400, disabled: !labelsHidden, className: styles['destination-wrapper'], children: element }, id || index));
                }) }), bottomSlot && (_jsx("div", { className: styles['bottom-slot'], children: bottomSlot }))] }));
}
