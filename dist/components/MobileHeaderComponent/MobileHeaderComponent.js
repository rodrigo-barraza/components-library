...
export default function MobileHeaderComponent({ brandLabel, brandIcon, onMenuClick, children, className, }) {
    return (_jsxs("header", { className: `mobile-header-component ${styles['mobile-header']} ${className || ""}`, children: [_jsx("button", { type: "button", className: styles['menu-button'], onClick: onMenuClick, "aria-label": "Open navigation menu", children: _jsx(Menu, { size: 22, strokeWidth: 2 }) }), _jsxs("div", { className: styles['brand'], children: [typeof brandIcon === "string" ? (_jsx("img", { src: brandIcon, alt: brandLabel || "Brand", className: styles['brand-icon'] })) : brandIcon ? (_jsx("span", { className: styles['brand-icon-node'], children: brandIcon })) : null, brandLabel && _jsx("span", { className: styles['brand-label'], children: brandLabel })] }), children && _jsx("div", { className: styles['actions'], children: children })] }));
}
