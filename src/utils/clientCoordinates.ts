 ...
 */
const TIMEZONE_COORDINATES: Record<string, readonly [number, number]> = {
 ...
 */
export function estimateClientCoordinates(timeZone?: string): GeoCoordinates {
  let zone = timeZone;
  if (zone === undefined) {
    try {
...
export const TIMEZONE_COORDINATE_COUNT = Object.keys(
